...
def parse_arg() -> argparse.Namespace:
    ...
    parser.add_argument("--in_file", type=str, default="en_dataset.csv")
    parser.add_argument("--out_file", type=str, default="en_dataset_clean.tsv")
...
def read_csv(
    ...
    """
    parse a csv file under dataframe format
    :param path:
    :param escapechar:
    :param na_values:
    :param delimiter:
...
if __name__ == '__main__':
    ...
    m = np.array([np.array([1.,2.,3.]), np.array([3.,4.,5.]), np.array([0.5, 0.6, 0.7])])
    ...
    collector = []
    for idx, text, sentiment, directness in df[['tweet', 'sentiment', 'directness']].itertuples():
